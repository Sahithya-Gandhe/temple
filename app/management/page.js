    ...
    <>
      ...
      <section className="relative h-[45vh] min-h-[320px] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image src="/assets/templeinfra1stpage.jpeg" alt="Temple Management" fill className="object-cover" />
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/30 to-[#2A2018]/70" />
        </div>
        <div className="relative z-10 text-center text-white px-6">
          <p className="text-[#DAA520] text-[13px] tracking-[0.2em] uppercase mb-3" style={{fontFamily:'Inter,sans-serif'}}>Stewardship</p>
          <h1 className="text-[2.5rem] md:text-[3.5rem] mb-4 text-white" style={{fontFamily:'Cinzel,serif', fontWeight:600}}>Temple Management</h1>
          <p className="text-white/80 text-[17px]" style={{fontFamily:'EB Garamond,serif'}}>Generations of Devoted Stewardship</p>
        </div>
      </section>
        ...
        <div className="container-temple">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-14">
              <p className="text-[19px] text-[#3A322D]/80 leading-[1.9]" style={{fontFamily:'EB Garamond,serif'}}>
                ...
                for the temple's maintenance was entrusted to the <strong className="text-[#5C1A1B]">Mogili Reddy family</strong>, who
            ...
            <div className="mb-16">
              <h2 className="text-[1.8rem] text-[#5C1A1B] text-center mb-10" style={{fontFamily:'Cinzel,serif'}}>
                Honourable Trustees
              </h2>

              <div className="max-w-3xl mx-auto mb-12">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border-2 border-[#B8860B]/20">
                  ...
                  <div className="bg-gradient-to-r from-[#5C1A1B] via-[#7B3F1A] to-[#5C1A1B] p-5 text-center">
                    <p className="text-[#DAA520] text-[12px] tracking-[0.15em] uppercase mb-2" style={{fontFamily:'Inter,sans-serif'}}>Hereditary Trustees & Managing Trustees</p>
                    <div className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-5">
                      ...
                      <span className="text-[#B8860B] hidden md:inline">❖</span>
              ...
              <div className="space-y-8">
                <div className="bg-[#FAF6F0] p-8 rounded-xl border border-[#C49A6C]/20">
                  <div className="text-center md:text-left">
                    <h3 className="text-[1.4rem] text-[#5C1A1B] mb-2" style={{fontFamily:'Cinzel,serif'}}>
                      Sri M. Chandramouli Reddy, IAS Garu
                    </h3>
                    <p className="text-[#B8860B] font-medium text-[14px] mb-4" style={{fontFamily:'Inter,sans-serif'}}>Hereditary Trustee</p>
                ...
                <div className="bg-[#FAF6F0] p-8 rounded-xl border border-[#C49A6C]/20">
                  <div className="text-center md:text-left">
                    ...
                    <p className="text-[#B8860B] font-medium text-[14px] mb-4" style={{fontFamily:'Inter,sans-serif'}}>Managing Trustee (41 years)</p>
                    <p className="text-[#3A322D]/70 leading-[1.85] text-[16px]" style={{fontFamily:'EB Garamond,serif'}}>
                ...
                <div className="bg-[#FAF6F0] p-8 rounded-xl border border-[#C49A6C]/20">
                  <div className="text-center md:text-left">
                    ...
                    <p className="text-[#B8860B] font-medium text-[14px] mb-4" style={{fontFamily:'Inter,sans-serif'}}>Managing Trustee (17 years)</p>
                    <p className="text-[#3A322D]/70 leading-[1.85] text-[16px]" style={{fontFamily:'EB Garamond,serif'}}>
            ...
            {/* Legacy */}
            <div className="bg-gradient-to-r from-[#5C1A1B] to-[#7B3F1A] p-8 md:p-12 rounded-xl text-white text-center shadow-2xl">
              <h3 className="text-[1.5rem] mb-6 text-white" style={{fontFamily:'Cinzel,serif'}}>A Legacy of Service</h3>
            ...
            <div className="my-12 text-center">
              <p className="text-[#3A322D]/70 text-[16px]" style={{fontFamily:'EB Garamond,serif'}}>
                The temple is also popularly known as <strong className="text-[#5C1A1B]">Sri Mukkoti
